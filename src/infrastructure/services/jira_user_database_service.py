...
class JiraUserDatabaseService(IJiraUserDatabaseService):
    ...
    async def update_user_by_jira_account_id(self, account_id: str, user_data: JiraUserDBUpdateDTO) -> JiraUserModel:
        ...
        try:
            return await self.user_repository.update_user_by_jira_account_id(account_id, user_data)
        except Exception as e:
    ...
    async def get_user_by_jira_account_id(self, account_id: str) -> Optional[JiraUserModel]:
        ...
        try:
            return await self.user_repository.get_user_by_jira_account_id(account_id)
        except Exception as e:
    ...
    async def get_users_by_project(self, project_key: str) -> List[JiraUserModel]:
        ...
        try:
            return await self.user_repository.get_users_by_project(project_key)
        except Exception as e:
