...
from src.app.dependencies.common import get_jira_api_admin_client, get_jira_api_client
...
) -> AsyncGenerator[IJiraSprintAPIService, None]:
    """Get Jira sprint API service"""
    yield JiraSprintAPIService(
        client=jira_api_client,
        admin_client=jira_api_admin_client
    )


def get_jira_sprint_repository(
...
) -> AsyncGenerator[IJiraSprintDatabaseService, None]:
    """Get Jira sprint database service"""
    yield JiraSprintDatabaseService(sprint_repository)
