...
class JiraWebhookEventDTO(BaseModel):
    ...
    @classmethod
    def from_webhook_payload(cls, payload: Dict[str, Any]) -> "JiraWebhookEventDTO":
        """Create JiraWebhookEventDTO from raw webhook payload"""
